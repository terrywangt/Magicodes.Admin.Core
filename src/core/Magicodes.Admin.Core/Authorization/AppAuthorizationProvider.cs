...
namespace Magicodes.Admin.Authorization
{
    ...
    public partial class AppAuthorizationProvider : AuthorizationProvider
    {
        ...
        public override void SetPermissions(IPermissionDefinitionContext context)
        {
            ...
            administration.CreateChildPermission(AppPermissions.Pages_Administration_MiniProgram_Settings, L("MiniProgramSetting"));
            ...
            var articleInfo_articleTagInfos = pages.CreateChildPermission(AppPermissions.Pages_ArticleInfo_ArticleTagInfo, L("ArticleTagInfos"));
            ...
            var articleSourceInfo = pages.CreateChildPermission(AppPermissions.Pages_ArticleSourceInfo, L("ArticleSourceInfo"));
