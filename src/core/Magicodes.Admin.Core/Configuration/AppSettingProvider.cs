...
namespace Magicodes.Admin.Configuration
{
    ...
    public class AppSettingProvider : SettingProvider
    {
        ...
        private IEnumerable<SettingDefinition> GetHostSettings() => new[]
        {
            ...
            //TODO:是否启用租户登陆默认为true
            new SettingDefinition(AppSettings.TenantManagement.UseEnableTenantLogin,
                GetFromAppSettings(AppSettings.TenantManagement.UseEnableTenantLogin, "true"),
                isVisibleToClients: true),
            ...
            new SettingDefinition(AppSettings.UiManagement.Header.DesktopMinimizeMode,
                GetFromAppSettings(AppSettings.UiManagement.Header.DesktopMinimizeMode, ""), isVisibleToClients: true,
                scopes: SettingScopes.All),
