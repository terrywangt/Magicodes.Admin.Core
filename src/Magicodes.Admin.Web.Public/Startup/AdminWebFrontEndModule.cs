...
namespace Magicodes.Admin.Web.Public.Startup
{
    ...
    public class AdminWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public AdminWebFrontEndModule(IHostingEnvironment env, AdminEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(AdminWebFrontEndModule).GetAssembly());
        }
    }
}
